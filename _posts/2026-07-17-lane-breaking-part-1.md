...
A lot of my career has felt like a smaller version of overlaps like these. And if Jeremy Gutsche is right in his book [*Exploiting Chaos*](https://www.createthefuturebook.com/), that times of disruption are when you're supposed to smash molds and let the multi‑passionate weirdos loose; then this is exactly the wrong moment for studios to shove people back into single, safe lanes and lean hard into specialization. Game development is heading into a new renaissance; we need smaller teams and more multi‑talented people to fill them (history doesn't repeat itself, it rhymes.)
...
On paper, that sounds reasonable. Clear ownership matters. Infinite [bikeshedding](https://thedecisionlab.com/biases/bikeshedding) is bad. Nobody wants a room where every minor decision turns into a 20‑person design review.
...
1. **Part 1: A Manifesto on Psychological Safety and Cross-Disciplinary Work** *(you're reading this)*
...
4. [Part 4: Polymaths in a Specialist World](/blog/lane-breaking-part-4/)
